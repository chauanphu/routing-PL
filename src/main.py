...
from utils.route import SASolution, init_solution
from utils.solver import PSOSolver, SimulatedAnnealingSolver
...
def pso_main():
    ...
    visualize_orders(orders, "Aac1")
    # psoSolver = PSOSolver()
    # psoSolver.init_swarm(orders)
